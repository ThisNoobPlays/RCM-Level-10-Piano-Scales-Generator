...
const harmonicMinor4octave = ["F sharp harmonic minor Four-Octave Scale", "G harmonic minor Four-Octave Scale", "A flat harmonic minor Four-Octave Scale", "A harmonic minor Four-Octave Scale", "B flat harmonic minor Four-Octave Scale", "B harmonic minor Four-Octave Scale"];
const melodicMinor4octave = ["F sharp melodic minor Four-Octave Scale", "G melodic minor Four-Octave Scale", "A flat melodic minor Four-Octave Scale", "A melodic minor Four-Octave Scale", "B flat melodic minor Four-Octave Scale", "B melodic minor Four-Octave Scale"];
...
const fourNoteChordsMinor = ["F sharp Minor four-note chords root position and inversions", "G Minor four-note chords root position and inversions", "A flat Minor four-note chords root position and inversions", "A Minor four-note chords root position and inversions", "B flat Minor four-note chords root position and inversions", "B Minor four-note chords root position and inversions"];
...
const dim7th = ["F sharp Minor diminished 7th chords root position and inversions", "G Minor diminished 7th chords root position and inversions", "A flat Minor diminished 7th chords root position and inversions", "A Minor diminished 7th chords root position and inversions", "B flat Minor diminished 7th chords root position and inversions", "B Minor diminished 7th chords root position and inversions"];
...
const minorTonicArp = ["F sharp Minor tonic arpeggios root position and inversions", "G Minor tonic arpeggios root position and inversions", "A flat Minor tonic arpeggios root position and inversions", "A Minor tonic arpeggios root position and inversions", "B flat Minor tonic arpeggios root position and inversions", "B Minor tonic arpeggios root position and inversions"];
...
const dim7Arp = ["F sharp Minor diminished 7th arpeggios root position and inversions", "G Minor diminished 7th arpeggios root position and inversions", "A flat Minor diminished 7th arpeggios root position and inversions", "A Minor diminished 7th arpeggios root position and inversions", "B flat Minor diminished 7th arpeggios root position and inversions", "B Minor diminished 7th arpeggios root position and inversions"];
